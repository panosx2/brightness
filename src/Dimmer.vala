...
namespace Gtk {
    public class Dimmer : Gtk.Application {
        public Dimmer () { Object (application_id: "com.github.panosx2.brightness",flags: ApplicationFlags.FLAGS_NONE); }
        ...
        public static int main(string[] args) { return new Dimmer().run (args); }
    }
}
